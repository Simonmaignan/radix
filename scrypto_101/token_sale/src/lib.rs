...
mod token_sale {
    ...
    impl TokenSale {
        ...
        pub fn instantiate_token_sale(price_per_token: Decimal) -> Global<TokenSale>{
            ...
            let bucket_of_useful_token = ResourceBuilder::new_fungible(OwnerRole::None)
            .metadata(metadata!(
                init {
        ...
        pub fn buy_useful_token(&mut self, mut payment: FungibleBucket) -> (FungibleBucket, FungibleBucket){
